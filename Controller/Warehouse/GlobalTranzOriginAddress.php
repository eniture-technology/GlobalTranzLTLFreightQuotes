...
namespace Eniture\GlobalTranzLTLFreightQuotes\Controller\Warehouse;
...
class GlobalTranzOriginAddress extends Action
{
    /**
     * @var Data Object
     */
    ...
    {
        $licenseKey = $this->scopeConfig->getValue('gtConnSettings/first/licnsKey', ScopeInterface::SCOPE_STORE);
        $post = [
            'acessLevel' => 'address',
            'address' => $originZip,
        ...
        return $this->dataHelper->cerasisSendCurlRequest($curlUrl, $post, true);
    }
